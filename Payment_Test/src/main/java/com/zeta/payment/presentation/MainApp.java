...
public class MainApp {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    login(userService, paymentService);
                    break;
                case 3:
    ...
    private static void login(UserService userService, PaymentService paymentService) {
        ...
        switch (role) {
            case ADMIN:
                adminMenu(userService, paymentService);
                break;
            case FINANCE_MANAGER:
                managerMenu(paymentService);
                break;
            case VIEWER:
                viewerMenu(paymentService);
                break;
            default:
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    generateMonthlyReport(paymentService);
                    break;
                case "5":
                    generateQuarterlyReport(paymentService);
                    break;
                case "6":
                    paymentService.viewAuditTrail();
                    break;
                case "7":
                    addUser(userService);
                    break;
